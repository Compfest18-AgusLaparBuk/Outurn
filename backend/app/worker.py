            ...
            with httpx.Client(timeout=10.0, follow_redirects=False) as client:
                response = client.post(
                    ...
                    headers={
                        ...
                        "X-GateGuard-Event": str(delivery["event_type"]),
                        "X-GateGuard-Delivery": str(delivery["id"]),
                        "X-GateGuard-Nonce": str(delivery["id"]),
                        "X-GateGuard-Timestamp": timestamp,
                        "X-GateGuard-Signature": f"sha256={signature}",
                    },
                )
