...
const SIDEBAR_CHANGE_EVENT = "outurn.sidebar.change";
...
function getSidebarSnapshot() {
  return window.localStorage.getItem("outurn.sidebar.collapsed") === "true";
}
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  function setSidebarOpen(open: boolean) {
    const next = !open;
    window.localStorage.setItem("outurn.sidebar.collapsed", String(next));
