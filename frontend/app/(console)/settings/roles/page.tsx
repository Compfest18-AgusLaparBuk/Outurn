  ...
  return (
    <div className="operations-page">
      <PageHeader
        ...
        description={t.rolesPermissionsPageDescription}
      />
      <section className="data-panel data-panel--wide">
        <div className="table-scroll">
          <Table>
            <Table.Header sticky>
              <Table.Row>
                <Table.Head>{t.permission}</Table.Head>
                <Table.Head>Operator</Table.Head>
                <Table.Head>Peninjau</Table.Head>
                <Table.Head>Administrator</Table.Head>
              </Table.Row>
            </Table.Header>
            <Table.Body>
              {permissions.map(([key, label, operator, reviewer, admin]) => (
                <Table.Row key={key}>
                  <Table.Cell>
                    <span className="table-cell-primary">{label}</span>
                    <small>{key}</small>
                  </Table.Cell>
                  <Table.Cell>{operator ? t.allowed : "—"}</Table.Cell>
                  <Table.Cell>{reviewer ? t.allowed : "—"}</Table.Cell>
                  <Table.Cell>{admin ? t.allowed : "—"}</Table.Cell>
                </Table.Row>
              ))}
            </Table.Body>
          </Table>
